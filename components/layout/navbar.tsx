    ...
    >
      <div className="container mx-auto p-[2rem] flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link href="/project" className="relative text-sm font-medium hover: transition-colors group">
            Projects
          ...
          <Link href="/work" className="relative text-sm font-medium hover: transition-colors group">
            Work
            <div className="bg-gradient-to-r from-rose-400 to-red-500 inset-0 z-[-1] w-full h-full rounded-full absolute blur opacity-0 transition-opacity group-hover:opacity-100  duration-200">
        ...
        <Sheet>
          ...
          <SheetContent side="right">
            <div className="flex flex-col gap-6 mt-10 mx-4">
              ...
              <Link href="/project" className="text-lg font-medium hover: transition-colors">
                Projects
              </Link>

              <Link href="/work" className="text-lg font-medium hover: transition-colors">
                Work
              </Link>
              <Button asChild>
                <Link href="#contact">Hire Me</Link>
